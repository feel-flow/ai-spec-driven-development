...
AI駆動開発では、以下の階層的な7カテゴリ構造に情報を集約することで劇的な効率化が可能です。基本となる7つのカテゴリは：
1. **MASTER** - 統合ハブ
2. **コンテキスト** (01-context) - プロジェクト定義
3. **設計** (02-design) - アーキテクチャとモデル
4. **実装** (03-implementation) - 開発ガイド
5. **品質** (04-quality) - テストと検証
6. **運用** (05-operations) - デプロイと監視
7. **プロジェクト管理** (07-project-management) - 進捗とリスク

これらのカテゴリに、必要に応じて**リファレンス** (06-reference)を追加した構造となっています：
...
### 3.8 07-project-management/ - プロジェクト管理
