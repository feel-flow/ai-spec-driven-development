...
**AI侍**: 「ふむ、今日は『余白を残す』ことの大切さを学んだであろう」

**DJ町娘**: 「はい！細かすぎる指示だと、AIは『実行』に専念しちゃって、考えてくれないんですね」

**AI侍**: 「その通りである。では、2つのモードの使い分けを整理しよう」

### 🗡️ AI侍の秘伝書

**其の一、精度モードと推論モードを見分ける**

```text
仕様は決まっている？
  ├─ はい → 精度モード「〇〇を実装して」
  └─ いいえ → 推論モード「〇〇について、どう思う？」
```
...
```text
❌「キャッシュを追加して」
✅「キャッシュを追加して。APIが遅くてユーザーから苦情が来てるから」
```
...
- 🔴 細かく指示しすぎ → AIは「実行」だけ（推論しない）
- 🟡 余白を残す → AIが「考える」余地ができる
- 🟢 「どう思う？」で提案を引き出す → アイデアが広がる！

**AI侍**: 「うむ。AIを壁打ち相手として使えば、自分では思いつかないアイデアも得られる。これが推論モードの真価である」
