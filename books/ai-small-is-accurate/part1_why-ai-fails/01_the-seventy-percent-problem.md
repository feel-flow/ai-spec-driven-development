...
> **続きは後編へ**
>
> ここまで、「70%問題」がどのように発生し、具体的にどんな影響を与えるかを見てきました。
>
> 後編では、この問題が引き起こす**4つの隠れたコスト**（時間・認知・機会・チーム）と、
> **解決策の糸口「コンテキスト縮小戦略」**を探ります。
>
> → [第1章 後編：隠れたコストと解決策の糸口](01b_hidden-costs-and-solutions.md)
...
【DJ町娘】「AI侍さん！私、まさにこの経験ありました...ChatGPTに長いレポート頼んだら、なんか薄い内容になっちゃって」

【AI侍】「それが『70%問題』の正体だ。AIに大きなタスクを丸投げすると、必ずこうなる」

【DJ町娘】「でも、なんでそうなるんですか？AIって賢いはずなのに...」

【AI侍】「良い質問だ。AIの『見える範囲』には限界がある。大きなタスクを渡すと、**懐中電灯で10畳の部屋を照らす**ようなもの。全体がぼやけるのだ」

【DJ町娘】「あー、なるほど！だから細部が疎かになっちゃうんですね」

【AI侍】「その通り。スタンフォード大学の研究『Lost in the Middle』でも証明されている。長い入力の**中間部分を忘れやすい**という現象だ」
...
「全部やって」「包括的に」「完全に」——これらの言葉は、AIにとって**最も苦手なお願い**である。

- ❌ 「5000字の包括的な記事を書いて」→ 表面的な羅列になる
- ❌ 「完全な認証システムを実装して」→ 細部の考慮が抜ける
- ❌ 「業界全体を調査して」→ 既知情報のコピペになる

#### 心得その2：精度低下の3パターンを覚えよ

大きなタスクでAIが失敗するパターンは、主に3つ。

1. **汎用化**：誰にでも当てはまるが、誰にも役立たない
2. **表面化**：動くが、深い考慮がない
3. **推測の増加**：具体的な情報がないから、AIが「多分こうだろう」で補う

#### 心得その3：70%の先にある「隠れたコスト」を見よ

70%の完成度で止まるということは、**残り30%を人間が埋める**ということ。

- 時間のコスト：AI生成＋手直し > 最初から手動
- 認知のコスト：「AIの出力を検証する」という余計な作業
- チームのコスト：PRレビューで大量の指摘
...
1. **AIは大きなタスクが苦手** - 「全部やって」で70%止まり
2. **Lost in the Middle** - 長い入力の中間を忘れる
3. **3つの失敗パターン** - 汎用化・表面化・推測増加

【DJ町娘】「じゃあ、どうすればいいんですか？」

【AI侍】「それは後編で詳しく解説する。キーワードは**『コンテキスト縮小戦略』**——AIが見る範囲を狭めることで、精度を引き上げる方法だ」

【DJ町娘】「楽しみです！後編も頑張って読みます🎧」
