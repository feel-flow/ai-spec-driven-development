...
![期待と実際のシナリオ比較](./images/01b_expected_vs_actual_flowchart.png)
...
![PRレビューでの手戻りフロー](./images/01b_pr_review_loop.png)
...
![AIユーザーの感情的な旅路](./images/emotional_journey.png)
...
![大きなお願いvs小さなお願い](./images/big_vs_small_requests.png)
...
![Lost in the Middle現象](./images/01b_lost_in_middle.png)
...
![隠れたコストの氷山](./images/column_01-2_iceberg.png)

**DJ町娘**：「先生、時間さえ気をつければ大丈夫ですよね？」

**AI侍**：「甘い！時間は氷山の一角に過ぎぬ」

**DJ町娘**：「氷山...ですか？」

**AI侍**：「うむ。見えている部分（時間コスト）は全体の1割。残りの9割は海面下に隠れておる」

**DJ町娘**：「認知コスト、機会コスト、チームコスト...確かに見えにくいですね！」

**AI侍**：「これが『隠れたコスト』の正体じゃ。最も危険なのは、**見えていないことに気づかない**こと。次章では、このコストを生む『Lost in the Middle』現象を科学的に解明するぞ」

**DJ町娘**：「原因がわかれば、対処法も見えてきますね！🎧」
