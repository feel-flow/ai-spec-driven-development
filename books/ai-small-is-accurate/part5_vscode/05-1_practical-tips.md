...
- **Lost in the Middle**（第2-1章）：即答型AIは長い入力の**中間部分を忘れやすい**
- **Lost at the Beginning**（第2-2章）：熟考型AIは**最初の情報を軽視しやすい**
...
## 5.4　VS Code入門──AIと連携できるファイル管理ツール
...
## 5.5　ファイルサイズの重要性──大きいファイルが良くない理由
...
**DJ町娘**: 「先生、ファイル整理って面倒くさいです...全部1つのファイルにまとめちゃダメですか？」

**AI侍**: 「ふむ。では聞こう。大工が1つの袋に、のこぎりも、かんなも、釘も、全部ごちゃ混ぜに入れていたらどう思う？」

**DJ町娘**: 「えっ...それは使いにくそう。必要な道具を探すのに時間かかりますよね」

**AI侍**: 「その通り。熟練の職人ほど、道具を**役割ごとに整理**しておる。のこぎりはのこぎりの場所、釘は釘の場所。必要な時にすぐ取り出せるようにな」

**DJ町娘**: 「あ！それってファイル整理と同じ...？」

**AI侍**: 「察しが良いの。AIに仕事を頼む時も同じじゃ。『この道具箱の中から、のこぎりだけ使って板を切れ』と言えれば、AIは迷わず作業できる。しかし全部ごちゃ混ぜの袋を渡されたら...」

**DJ町娘**: 「Lost in the Middleですね！道具の山の中で迷子になっちゃう！」

**AI侍**: 「ファイル整理とは、**AIのための道具箱づくり**なのじゃ。職人は道具を見ればその腕がわかる。お主のフォルダ構成を見れば、AIとの付き合い方がわかるというものよ」
