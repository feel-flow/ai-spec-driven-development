...
**AI侍**: 「ふむ、ファイル分割の極意を授けよう」

**DJ町娘**: 「師匠、なんで500行なんですか？400行じゃダメなの？」

**AI侍**: 「良い質問である。500行というのは厳密な数字ではない」

### 🗡️ AI侍の秘伝書

**其の一、500行は「人間が把握できる量」**

- AIに渡す前に、人間がファイルを開いて全体像を把握できるか
- スクロールが何度も必要なら、AIにとっても難しい

**其の二、一緒に変わるものは一緒に置く**

- 登録処理と退会処理 → 別々に変わる → 分ける
- 型定義とバリデーション → 一緒に変わる → 一緒にする
...
- 🔴 大きすぎるファイル → AIも人間も把握できない
- 🟡 500行以下が目安 → 人間が一目で把握できる量
- 🟢 「変更の単位」で分ける → AIのコンテキスト設計になる！

**AI侍**: 「うむ。ファイル分割とは、AIのコンテキストを設計することである」
