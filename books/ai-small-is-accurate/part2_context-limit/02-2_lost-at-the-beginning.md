...
![即答型と熟考型AIの比較](./images/02b_two_types_of_ai.png)
...
## ◼︎即答型の弱点：Lost in the Middle（振り返り）
...
## ◼︎熟考型の弱点：Lost at the Beginning of Reasoning
...
![熟考型AIの処理プロセス](./images/reasoning_ai_process.png)
...
![熟考型AIの弱点](./images/reasoning_ai_weakness.png)
...
![即答型と熟考型の弱点比較](./images/two_weaknesses_comparison_ja.png)
...
![セールの服選び](./images/column_02-2_sale_clothes.png)

**教訓**: 即答型AIは「真ん中を忘れる」、推論型AIは「最初に決めたら変えない」。どちらも**小さく分ければ失敗しない**！👗
