...
![AIの正解率を示すU字曲線のグラフ。横軸は文書内の位置、縦軸は正解率。文書の最初と最後では正解率が高いが、中間部分では約50%まで大きく落ち込む様子が示されている。](./02_ucurve.png)
...
ここで、第1-1章の内容を振り返りましょう。

第1-1章では、AIに「全部やって」と頼むと
...
- [ ] 第1-1章の「70%問題」がLost in the Middleで説明できるか考える
...
![本棚の真ん中の本の比喩](./images/column_02-1_bookshelf.png)

**DJ町娘**：「先生、なんで真ん中だけ忘れるんですか？」

**AI侍**：「長い本棚を思い浮かべてみよ」

**DJ町娘**：「本棚...ですか？」

**AI侍**：「うむ。両端の本は目立つから覚えている。だが真ん中の本は...見落とされる。これが**Lost in the Middle**じゃ。AIも同じで、入力の最初と最後はよく見るが、真ん中は忘れやすい」

**DJ町娘**：「なるほど！だから小さく分ければ、全部が『端』になるんですね！」

**AI侍**：「その通り。次章では、もう1つの弱点『Lost at the Beginning』を学ぶぞ」
...
これが、第1-1章で見た「70%問題」の根本原因の1つでした。

でも、実は**AIにはもう1つの弱点**があります。

**Lost at the Beginning of Reasoning**──推論の最初で迷子になる。

これは2025年に発見された、**熟考型AI**（推論モデル）に特有の問題です。

次章では、この「もう1つの弱点」を学びます。
そして、**どちらの弱点にも効く共通の解決策**を明らかにします。

興味深いことに、解決策は同じなのです。

「**小さく分ける**」こと。

次章「Lost at the Beginning──最初で迷子になるAI」で、
AIの2種類の弱点と、その共通の解決策を学びましょう。
