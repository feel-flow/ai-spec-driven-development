...
![企画書の構成と反映度](./images/02_document_tree.png)
...
![位置による正解率のU字曲線](./images/02_ucurve.png)
...
![要件定義書の反映度](./images/02_text_reflection.png)
...
![画像生成プロンプトの反映度](./images/02_image_reflection.png)
...
![仕様書のコード反映度](./images/02_code_reflection.png)
...
![競合データのレポート反映度](./images/02_research_reflection.png)
...
![懐中電灯のメタファー](./images/02_flashlight_metaphor.png)
...
![位置による正解率の違い](./images/02_position_accuracy.png)
...
![70%問題の根本原因フローチャート](./images/02-1_70percent_root_cause.png)
...
![大きなお願いと小さなお願いの比較](./images/02_big_vs_small.png)
...
![映画構成とAI](./images/column_02-1_movie.png)

**DJ町娘**：「先生、なんで真ん中の情報だけ見落とすんですか？不公平じゃないですか！」
...
**DJ町娘**：「えっと…オープニングの衝撃と、ラストの感動シーン？」

**AI侍**：「その通り！中盤の伏線は、よほど印象的でない限り忘れられる」

**【映画の黄金律 = プロンプトの黄金律】**
1. **冒頭10分**：観客を掴む → AIに指示を明確に
2. **中盤**：伏線を張る → 70%しか伝わらない
3. **ラスト10分**：感動を残す → 最終指示で締める
