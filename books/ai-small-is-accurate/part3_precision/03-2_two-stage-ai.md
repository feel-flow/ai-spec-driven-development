...
**AI侍**: 「ふむ、二段階AI活用の極意を授けよう」

**DJ町娘**: 「AIに直接やらせると、合ってるかどうか分からないんですよね...」

**AI侍**: 「だから、AIには『判断』をさせず、『ツール』を作らせるのだ」
...
```text
❌ 「このコードをテストして、問題がないか確認して」
✅ 「このコードのテストコードを書いて」
```

**其の二、3つのパターンを使い分ける**

- チェックリスト生成：レビュー、校正、確認作業に
- テストコード生成：コード品質の検証に
- 評価基準生成：クリエイティブ作業の評価に
...
- 🔴 AIに直接判断させる → 信じるしかない（危険）
- 🟡 AIにツールを作らせる → 検証できる（安全）
- 🟢 人間が最終判断 → 責任を持てる（安心）

**AI侍**: 「うむ。次は『余白を残す』──AIの推論力を活かす方法を学ぶぞ」
...
ここまで、「精度を上げる」方法を学んできました。

- **スコープ収束パターン**: 小さく分けて精度を上げる
