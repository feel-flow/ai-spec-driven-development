...
module.exports = {
  ...
  files: [
    ...
    'part2_spec-is-90percent/08_decision-matrix.md',
    'part2_spec-is-90percent/09_change-impact.md',
    ...
    'part3_practice/12_claude-code-skills.md',
    'part3_practice/12a_copilot-agents.md',
