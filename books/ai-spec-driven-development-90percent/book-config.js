...
module.exports = {
  ...
  files: [
    ...
    'part3_practice/09_daily-workflow.md',
    'part3_practice/10_claude-code-skills.md',
    'part3_practice/11_copilot-agents.md',
    'part4_faq/12_engineer-role.md',
    'part4_faq/13_quality-security.md',
    'part5_organization/14_team-standardization.md',
    'part5_organization/15_roadmap-knowledge.md',
    '99_afterword.md',
