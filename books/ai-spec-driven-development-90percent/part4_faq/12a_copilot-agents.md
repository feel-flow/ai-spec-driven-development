...
この章では、GitHub Copilot Agentsを使って仕様駆動開発を自動化する方法を学びました。Claude Code（前章）とGitHub Copilot（本章）のどちらを使っても、同等のレビュー機能を実現できることがわかりました。
...
【AI侍】「この章で学んだ『エージェント』——それぞれに得意技がある。**適材適所**が肝要である」

【DJ町娘】「AI侍さん、エージェントっていっぱいありますけど、どれを使えばいいんですか？」

【AI侍】「**すべてを使う必要はない**。状況に応じて、最適な1つを選べばよい」

【DJ町娘】「状況に応じて...？」

【AI侍】「うむ。コードレビューなら code-reviewer、テスト分析なら test-analyzer、コメント精査なら comment-analyzer——それぞれに役割がある」

【DJ町娘】「なるほど、専門家に任せる感じですね」

【AI侍】「その通り。**汎用エージェント1つより、専門エージェント6つ**の方が、的確な指摘が得られる」
...
【DJ町娘】「なるほど！つまり、**エージェントは『専門家』だから、見てほしいことに応じて使い分ける**んですね。Claude CodeでもCopilotでもいいし、大事なのは『仕様駆動』という本質を守ること✨」

【AI侍】「見事なまとめである。次章では、チーム標準化——個人の取り組みをチーム全体に広げる技術を学ぶ」
