...
**［第4部］** 「結局エンジニアが書くのでは？」「品質は大丈夫？」「責任は誰が取る？」——導入時に必ず出る疑問に答えます。懐疑派を納得させる論理と、実装を自動化するツール活用法を解説。
...
「コードを書く時間」だけを見ていると、隠れたコストが見えません。

著者が複数の開発現場で観察した結果、エンジニアの作業時間配分は大まかに以下のような傾向がありました（プロジェクトの特性により大きく異なることに注意してください）。
...
**注記**：これらの数値は著者の経験的な観察に基づく概算であり、プロジェクトの性質（新規開発 vs 保守、チーム規模、技術スタックなど）によって大きく変動します。
...
【AI侍】「この章で学んだ『エンジニアの役割』——それは**創造から監督へ**の転換である」

【DJ町娘】「AI侍さん、AIがコード書くなら、エンジニアって要らなくなっちゃうんですか...？」

【AI侍】「**それは大きな誤解である**。エンジニアの価値は『コードを書くこと』ではない。『正しいものを作ること』だ」

【DJ町娘】「正しいものを作る...？」

【AI侍】「うむ。コードを書くのは**手段**であって、**目的**ではない。本当の価値は、『何を作るべきか』を判断し、『これで正しいか』を検証することにある」

【DJ町娘】「確かに...AIは『これが正しい』って判断できないですもんね」

【AI侍】「その通り。だからこそ、エンジニアの役割は**『作る人』から『判断する人』**へと進化するのだ」

---

### 🗡️ AI侍の秘伝書

AI時代のエンジニアが磨くべき3つの新しい価値を授ける。

#### 秘伝その1：「仕様設計」の価値を磨け

AIがコードを書くなら、エンジニアは**仕様を設計する**ことに集中せよ。
...
この「曖昧さを排除する技術」こそ、AI時代の高度なエンジニアリングである。

#### 秘伝その2：「レビュー」の価値を磨け

AIが生成したコードを**正しく評価する目**を養え。
...
「80%まで到達したか」を見極める目——これが新しい価値だ。

#### 秘伝その3：「ナレッジ化」の価値を磨け

レビューで見つけた問題を**次回に活かす**力を磨け。

- ❌ 旧：毎回同じ指摘をする
- ✅ 新：**指摘をPATTERNS.mdに記録する**
...
**ナレッジを蓄積する技術**——これこそ、AI時代のエンジニアの真価である。

---

### 🎧 DJ町娘のまとめ

【DJ町娘】「なるほど！つまり、**AIがコードを書く時代、エンジニアの価値は『判断』と『設計』と『蓄積』**なんですね。仕様を設計して、AIが書いたコードを正しく判断して、知見をナレッジ化する——これが新しいエンジニアの仕事✨」

【AI侍】「見事なまとめである。次章では、品質とセキュリティ——『AIが書いたコードの責任は誰が取るのか』を学ぶ」

【DJ町娘】「大事なテーマですね！楽しみです🎧」
