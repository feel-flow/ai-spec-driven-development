...
【AI侍】「この章で学んだ『Issue』——それは単なるタスク管理ツールではない。**芸術**である」

【DJ町娘】「え！？Issueが芸術...ですか？」

【AI侍】「うむ。良いIssueは、**AIへの完璧な設計図**である。曖昧さがなく、制約が明確で、ゴールが見える——まるで名工が描いた設計図のようだ」

【DJ町娘】「でも、Issueって『タスクを書くだけ』じゃないんですか？」

【AI侍】「それが素人の考えである。**Issueは仕様の凝縮**だ。受け入れ基準、技術的制約、スコープ外——この3つが揃えば、AIは迷わず実装できる」

【DJ町娘】「なるほど...Issueの書き方で、AIの動きが全然変わるんですね」

【AI侍】「その通り。**曖昧なIssueは曖昧な実装を生む。明確なIssueは明確な実装を生む**——これが鉄則である」
...
【DJ町娘】「なるほど！つまり、**Issueは『AIへの設計図』**なんですね。受け入れ基準で『何が正しいか』を示して、技術的制約で『どう作るか』を示して、スコープ外で『何を作らないか』を示す——これで完璧な設計図✨」

【AI侍】「見事なまとめである。次章では、文書追加の判断——『この情報はどの文書に置くべきか』を学ぶ。Decision Matrixの使い方を体得せよ」
