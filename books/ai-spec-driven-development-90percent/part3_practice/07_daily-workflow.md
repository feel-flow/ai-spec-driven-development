...
ここまで「良いIssue」の書き方を見てきましたが、現実には毎回ゼロから書くと品質がばらつきます。人によって書き方が違ったり、忙しいときにスコープ外を省略してしまったり。

**解決策は、GitHub Issue テンプレートを使って「型」を強制すること** です。

### GitHub Issue Template 機能
...
再現手順を書くことで「何が壊れているか」が限定され、AIは修正範囲を正確に特定できます。新機能テンプレートと比べて必須参照が少ない点にも注目してください。バグ修正ではDOMAIN全体を読む必要はなく、関連Issueとパターン集だけで十分です。
