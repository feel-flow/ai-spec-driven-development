...
【AI侍】「この章で学んだ『影響度評価』——これは**変更を恐れぬ心**を養う技術である」

【DJ町娘】「変更を恐れない...？でも、変更って怖くないですか？何かが壊れそうで...」

【AI侍】「**恐れるのは『未知』だからだ**。影響度が見えれば、恐れは消える」

【DJ町娘】「影響度が見える...？」

【AI侍】「うむ。『この変更、どこまで影響するの？』が分からぬから恐れる。だが影響度評価（changeImpact）を使えば、**変更前に影響範囲が見える**」

【DJ町娘】「確かに、影響範囲が分かれば安心ですね」

【AI侍】「そうだ。LOW（局所的）、MEDIUM（波及的）、HIGH（構造的）——この3段階で変更を分類すれば、**どこまで確認すべきか**が明確になる」
...
【DJ町娘】「なるほど！つまり、**変更を恐れないコツは『影響度を見える化すること』**なんですね。LOW/MEDIUM/HIGHで分類して、HIGHにはADRを書いて、ドキュメントを先に変更する——これで安全に変更できる✨」

【AI侍】「見事なまとめである。次章からは現場FAQに入る。『エンジニアが全部書くのでは？』『品質は大丈夫？』——こうした疑問に答えていく」
