...
<!-- TODO: ch09-ai-samurai-dojo.png を生成して差し込む -->

<div class="column-box">

### 🥷 コラム：試食してからレシピを書け

**AI侍**: 「若者よ、"動くもの"を見てから筆を執れ。脳内の設計図は、必ずどこかが歪んでおるものだ」

**DJ町娘**: 「えー、でも仕様が先って第2部で言ってたじゃないですか〜！」

**AI侍**: 「うむ。だからこそ、仕様を"正しく"書くために、まず現実を知るのだ。PoCは仕様の下書きではない。仕様の**材料集め**である」

**DJ町娘**: 「材料集め…なるほど！ 料理で言うと、レシピを書く前に試食するみたいな？」

**AI侍**: 「そのとおり。そして忘れるな——試食で使った鍋は、本番では使わぬこと。PoCのコードは必ず捨てよ」

</div>

---

**次の章では**、PoCで方向性が固まった後の「日々の開発フロー」を詳しく見ていきます。仕様に基づいてAIにタスクを渡し、レビューし、ナレッジを蓄積する一連のサイクルです。
