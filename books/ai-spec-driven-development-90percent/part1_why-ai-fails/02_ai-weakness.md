...
【AI侍】「この章で学んだAIの本質——『強みと弱み』を見極める目を養おう」

【DJ町娘】「AI侍さん、AIってコーディングは得意なんですよね？でも心を読むのは苦手...ってどういうことですか？」

【AI侍】「**AIは『書かれたこと』は完璧に理解するが、『書かれていないこと』は推測するしかない**。そして推測は、多くの場合外れるのだ」

【DJ町娘】「書かれていないこと...例えばどんなことですか？」

【AI侍】「『ユーザー登録を作って』と言った時、パスワードの文字数制限は？メール確認は必要か？エラーコードは何番か？——これらを『当然わかるだろう』と思ってはならぬ。AIには見えぬのだから」

【DJ町娘】「確かに...言われないと分からないですよね」

【AI侍】「うむ。だからこそ、**AIの強みを活かす場面と、人間が明示すべき場面**を見極めることが肝要である」
...
【DJ町娘】「なるほど！つまり、**AIは『辞書を引く』のは得意だけど、『行間を読む』のは苦手**なんですね。だから『書かれていること』を増やして、『推測させること』を減らす——これがAIを活かすコツ✨」

【AI侍】「見事な理解である。次章では、この『書かれていること』をプロジェクト全体で体系化する——7文書構成を学ぶ。ここからが本書の核心だ」
