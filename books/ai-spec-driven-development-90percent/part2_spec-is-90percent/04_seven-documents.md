...
【AI侍】「さて、この章で学んだ7文書の本質を整理しよう」

【DJ町娘】「AI侍さん、この章で一番大事なポイントって何ですか？」

【AI侍】「**7文書は『分離の技術』である**。情報を適切に分離することで、矛盾を防ぎ、AIの迷いを消すのだ」

【DJ町娘】「分離...ですか？」

【AI侍】「うむ。例えば『ビジネスルール』と『実装パターン』を同じ場所に書くと、どうなると思う?」

【DJ町娘】「えーっと...どっちを見ればいいか分からなくなりそう」

【AI侍】「その通りである。だからこそ、DOMAIN.md にはビジネスルールのみを、PATTERNS.md にはコードの書き方のみを記す。**関心事の分離**——これが7文書の根幹である」
...
【DJ町娘】「なるほど！つまり、**7文書は『情報の住所録』**なんですね！それぞれの文書に明確な役割があって、情報が散らばらないから、AIも人間も迷わない✨」

【AI侍】「うむ、見事なまとめである。次章では、この7文書を日々の開発でどう回していくかを学ぶ。準備はよいか？」
