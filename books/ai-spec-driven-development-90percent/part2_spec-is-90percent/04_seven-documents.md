...
MASTER.mdには、プロジェクト概要・技術スタック・関連文書へのリンクを含めます。
...
PROJECT.mdには、ビジョン・ターゲットユーザー・機能要件・非機能要件を含めます。
...
ARCHITECTURE.mdには、システム構成図・技術スタック・コンポーネント設計・ADRを含めます。
...
DOMAIN.mdには、ドメインモデル・エンティティ定義・ビジネスルール・用語集を含めます。
...
PATTERNS.mdには、コーディング規約・頻出パターン・アンチパターンの3セクションを含めます。
...
TESTING.mdには、テストピラミッド・テストパターン・品質基準を含めます。
...
DEPLOYMENT.mdには、環境構成・デプロイ手順・CI/CDパイプライン・運用手順を含めます。
