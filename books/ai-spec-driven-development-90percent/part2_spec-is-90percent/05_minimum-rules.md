...
#### なぜドキュメントにセマンティックバージョニングを適用するのか
...
【AI侍】「7文書を『作る』ことと『回す』ことは別である。この章で学んだ『回し方』の極意を整理しよう」

【DJ町娘】「AI侍さん、7文書を作っても、更新されないと意味ないですよね？どうすれば『回る』ようになりますか？」

【AI侍】「**自動化と習慣化**——この2つである。人の意志に頼るな。仕組みで回せ」

【DJ町娘】「仕組みで回す...？」

【AI侍】「うむ。『文書を更新しましょう』と言うだけでは誰も更新せぬ。だが『PRを出したらFrontmatterチェックが走る』なら、嫌でも更新する」

【DJ町娘】「確かに！自動チェックがあれば、忘れないですね」

【AI侍】「そうだ。**忘れられない仕組み**こそが、7文書を回し続ける秘訣である」
...
【DJ町娘】「なるほど！つまり、**7文書を回すには『仕組み化』が大事**なんですね。Frontmatterで状態を見える化して、変更の型を決めて、自動チェックで忘れないようにする——これで『回り続ける』✨」

【AI侍】「見事なまとめである。次章からは、いよいよ実践に入る。7文書を使った日々のワークフローを学ぶ。準備はよいか？」
