...
**注意**: AI侍道場は章末チェックリストと次章への橋渡しの間に配置します。
...
| 学習目標 | ✅ | `## この章で学ぶこと` |
| 章末チェックリスト | ✅ | `## 章末チェックリスト` |
| AI侍道場 | ✅ | `<div class="ai-samurai-dojo">` |
| 次章橋渡し | ✅ | `## 次章への橋渡し` |
| 脚注 | 任意 | `[^1]:` など |
...
6. チェックリスト（`## 章末チェックリスト`）
7. 区切り線（`---`）
8. AI侍道場（`<div class="ai-samurai-dojo">`）
9. 区切り線（`---`）
10. 次章橋渡し（`## 次章への橋渡し`）
11. 区切り線（`---`）
12. （任意）脚注（`[^1]: ...`）
13. （任意）画像生成プロンプト（`## 画像生成プロンプト`）
