...
|------|--------|----------|
| 2024-01-15 | 田中 | 初版作成 |
| 2024-01-20 | 佐藤 | Claude Code向けガイドを追加 |
| 2024-01-25 | 山田 | GitHub Copilot向けガイドを追加 |
| 2024-02-01 | 田中 | Cursor向けガイドを追加 |
| 2024-02-05 | 佐藤 | 作業フローとよくある間違いを追加 |
| 2024-02-10 | 山田 | 緊急時対応と更新履歴を追加 |
